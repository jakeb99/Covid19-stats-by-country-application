 ...
 * @author misiksa
 */
public class AnalysisDeathCases {
    
    public static double getDeathCasesByCountry(String country){
        double count = 0;
        try{
        ...
        for(CSV csv: csvRecords){
               if(country.equalsIgnoreCase(csv.getCountry())){
                  //  System.out.println("Country: "+country+", Death Cases: "+csv.getNoOfDeathForDisaggregated());
                   return Double.parseDouble(csv.getNoOfDeathForDisaggregated());
               }
